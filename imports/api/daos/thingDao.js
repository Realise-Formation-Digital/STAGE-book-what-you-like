...
class ThingDao {
  ...
  static async insertThing(name, description , reserved, serial_number, parkingType = null, hasCable, hasWhiteBoard, timestamp){
    console.log('[ThingDao][insertThing] Inserting thing with params', name, description , reserved, serial_number, parkingType = null, hasCable, hasWhiteBoard, timestamp)
    try {
